...
@interface YOVedioPlayerViewController ()
...
@implementation YOVedioPlayerViewController
...
- (void)viewDidLoad {
    ...
    self.videoPlayer.contentURL = self.vedioUrl;
...
- (void)buildNavUI
{
    ...
    imageView.frame = CGRectMake(0, 0, ScreenWidth, 44);
    ...
    Done.frame = CGRectMake(ScreenWidth - 70, 0, 50, 44);
...
- (UIImage*)coverIamgeAtTime:(NSTimeInterval)time {
    ...
    AVURLAsset *asset = [[AVURLAsset alloc] initWithURL:self.vedioUrl options:nil];
