...
#define RECORD_MAX_TIME 10.0


@interface YOFileOutVedioModel ()<AVCaptureFileOutputRecordingDelegate>
...
@implementation YOFileOutVedioModel
...
- (void)captureOutput:(AVCaptureFileOutput *)captureOutput didFinishRecordingToOutputFileAtURL:(NSURL *)outputFileURL fromConnections:(NSArray *)connections error:(NSError *)error
{
    ...
    if ([YOFileManager isExistsAtPath:[self.videoUrl path]]) {
